...
class Task:
    ...
    def noticeTimer(self):
        print("Getting notice data from Internet...")
    ...
    def timetableTimer(self):
        print("Getting timetable data from Internet...")
    ...
    def nolecTimer(self):
        print("Getting no leacture data from Internet...")
    ...
    def addlecTimer(self):
        print("Getting add lecture data from Internet...")
    ...
    def callTimer(self):
        print("Getting student calling data from Internet...")
    ...
    def scholarshipTimer(self):
        print("Getting scholarship data from Internet...")
    ...
    def concentrationTimer(self):
        print("Getting concentrate lecture data from Internet...")
        ...
        if post_id != self.previous_scholarship_id:
            ...
            status = api.PostUpdate(post)
            self.previous_scholarship_id = post_id
        threading.Timer(self.refresh_time, self.concentrationTimer).start()

    def aboardTimer(self):
        print("Getting studying aboard data from Internet...")
        ...
        if post_id != self.previous_scholarship_id:
            ...
            status = api.PostUpdate(post)
            self.previous_scholarship_id = post_id
        threading.Timer(self.refresh_time, self.aboardTimer).start()
